...
TF_VARS=../../scripts/4-projects/bu1-development.auto.tfvars
COPY_LOCATION=.
...
echo Copying in needed bu1-non-production.auto.example.tfvars
TF_VARS=../../scripts/4-projects/bu1-non-production.auto.example.tfvars
COPY_LOCATION=.
[ -f $TF_VARS ] && { echo "Copying $TF_VARS to $COPY_LOCATION"; cp $TF_VARS $COPY_LOCATION; } || { echo "No $TF_VARS file found";  }
...
TF_VARS=../../scripts/4-projects/bu1-production.auto.example.tfvars
COPY_LOCATION=.
[ -f $TF_VARS ] && { echo "Copying $TF_VARS to $COPY_LOCATION"; cp $TF_VARS $COPY_LOCATION; } || { echo "No $TF_VARS file found";  }
